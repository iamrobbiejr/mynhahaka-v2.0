...
const SideBar = () => {
    ...
    return (
        <>
            <div
                className="flex flex-col items-center w-16 h-screen py-8 bg-white dark:bg-gray-900 dark:border-gray-700">
                <nav className="flex flex-col items-center flex-1 space-y-8 ">
                    ...
                    <a href="/leads"
                       className="p-1.5 inline-block text-gray-500 transition-colors duration-200 rounded-lg dark:text-blue-400 dark:bg-gray-800 hover:bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                             stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <div className="flex flex-col items-center mt-4 space-y-4">
                    <a href="#">
                        <img className="object-cover w-8 h-8 rounded-lg"
            ...
            {pathname === '/leads' && (
                <div
                    className="h-screen px-5 py-8 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 dark:bg-gray-900 dark:border-gray-700">
